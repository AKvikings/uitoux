                        ...
                        <div class="owl-carousel">
                            <a class="block-slideshow__item" href="">
                                <span
                                        ...
                                        style="background-image: url('assets/images/slide-1.jpeg')">
                                </span> 
                                <span
                                ...
                                <span
                                        class="block-slideshow__item-offer">30% OFF 
                                </span>
                                <span
                                        class="block-slideshow__item-title">When Buying Parts<br>With Installation
                                </span>
                                <span class="block-slideshow__item-details">Installation of parts in the services
                                        of<br>our partners. 
                                </span>
                            ...
                            <a
                                class="block-slideshow__item" href="">
                                <span
                                    class="block-slideshow__item-image block-slideshow__item-image--desktop"
                                    style="background-image: url('assets/images/slide-1.jpeg')">
                                </span>
                                ...
                                <span
                                    class="block-slideshow__item-button">Shop Now
                                </span>
                            </a>
                        </div>
                    </div>
                                ...
                                <div class="section-header__body">
                                    ...
                                    <div class="section-header__arrows">
                                        <div class="arrow section-header__arrow section-header__arrow--prev arrow--prev"><button
                                                class="arrow__button" type="button"><img src="assets/svg/left-arrow.svg" alt=""></button></div>
                                        <div class="arrow section-header__arrow section-header__arrow--next arrow--next"><button
                                                class="arrow__button" type="button"><img src="assets/svg/right-arrow.svg"></button></div>
                                    </div>
                                            ...
                                            <div class="product-card product-card--layout--grid">
                                                <div class="product-card__actions-list">
                                                    <button class="product-card__action product-card__action--quickview"
                                                        ...
                                                        <img src="assets/svg/quickview.svg" alt="">
                                                    </button> 
                                                    <button class="product-card__action wishListButton"
                                                        type="button" id="wishListButton-<?=$row['id']?>" data-custom-value="<?=$row['id']?>" aria-label="Add to wish list">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
                                                        <path d="M8 14.215l-.732-.658C3.825 10.223 1 7.364 1 4.5 1 2.42 2.343 1 4.5 1c1.082 0 2.132.498 2.804 1.36C8.368 1.498 9.418 1 10.5 1 12.657 1 14 2.42 14 4.5c0 2.864-2.825 5.723-7.268 9.057L8 14.215z"/>
                                                        </svg>
                                                    </button>
                                                </div>
                                                ...
                                                <div class="product-card__info">
                                                    <div class="product-card__meta"><span
                                                            class="product-card__meta-title">SKU:</span> <?=generate_random_number()?> </div>
                                                    <div class="product-card__name">
                                                        <div>
                                                            <div class="product-card__badges">
                                                                <?php 
                                                                     if($row['hot']){
                                                                         echo '<div class="tag-badge tag-badge--hot">hot</div>';
                                                                     }
                                                                ?>
                                                            </div><a href="#"><?=$row['name']?></a>
                                                        </div>
                                                    </div>
                                                    <div class="product-card__rating">
                                                        ...
                                                        <div class="product-card__rating-label"><?=generate_random_review()?></div>
                                                    </div>
                                                </div>
                                                <div class="product-card__footer">
                                                    <div class="product-card__prices">
                                                        <div class="product-card__price product-card__price--current">$<?=$row['price']?>
                                                        </div>
                                                    </div>
                                                    <button class="product-card__addtocart-icon" id=""  type="button"
                                                        aria-label="Add to cart"><img src="assets/svg/cart-20.svg" alt=""></button>
                            ...
                            <div class="block-banners__list">
                                <a href="" class="block-banners__item block-banners__item--style--one">
                                    ...
                                    <span class="block-banners__item-image block-banners__item-image--blur">
                                        <img src="assets/images/banner1.jpeg" alt=""></span>
                                ...
                                <a href="" class="block-banners__item block-banners__item--style--two">
                                    <span class="block-banners__item-image">
                                        <img src="assets/images/banner2.jpeg" alt=""></span>
                                        <span class="block-banners__item-image block-banners__item-image--blur">
                                            <img src="assets/images/banner2.jpeg" alt=""></span>
                                        ...
                                        <div class="block-products-columns__list-item">
                                            <div class="product-card">
                                                <div class="product-card__actions-list"><button
                                                        ...
                                                        type="button" aria-label="Quick view"><img src="./assets/svg/quickview.svg" alt=""></button></div>
                                                <div class="product-card__image">
                                                    <div class="image image--type--product"><a href="#"
                                                            class="image__body"><img class="image__tag"
                                                                src="<?=$row['image']?>" alt=""></a></div>
    ...
    <script>
        ...
        if(isset($_SESSION['wishlist'])){
            foreach ($_SESSION['wishlist'] as $product_id) {
                ?>
                let button_<?=$product_id?> = document.getElementById("wishListButton-"+<?=$product_id?>);
                
                button_<?=$product_id?>.style.color = "red";
                button_<?=$product_id?>.disabled = true;
            <?php
            }
        }
        ?>
        $(document).ready(function() {
            $(document).on('click', '.wishListButton', function(e) {
                ...
                let button = document.getElementById("wishListButton-"+id);
                ...
                $.ajax({
                    url: './index.php',
                    method: 'POST',
                    data: {action:"wishList", producId: id},
                    success: function(response) {
                        $('#wishCount').html(parseInt($('#wishCount').html()) + 1);
                        if(response){
                            alert("Wishlist added!"); // show the alert
                        }
                        else{
